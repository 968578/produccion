...
import './c-form-auditoria-confeccionista.css'
...
const FormAuditoria = (props) => {
  ...
  const submitAuditoria = () => {
    ...
    axios.post(`${process.env.REACT_APP_API_URL}/auditorias/insert-from-confeccionista`, input, {
      headers: {
  ...
  return (
    <div className="c-FormAuditConfeccionista" >
      <AnimatePresence>
        {
          props.active &&
          <motion.div exit='hidden' animate='show' initial='hidden' variants={variantsFormAuditoria} key='FormAuditoria' >
            ...
            <div className="cancelEdit" >
              <div onClick={props.activeEvent} className="containerEliminar">
                <div>Cancelar</div>
                <div className="L"></div>
                <div className="X"></div>
              </div>
