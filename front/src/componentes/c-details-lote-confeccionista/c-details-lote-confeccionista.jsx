...
const DetailsLoteConfeccionista = (props) => {
        ...
        dataLocal?.op ?
          <div>
            <div className="containerHomeButton">
              <Link to="/home-confeccionista" className="HomeFormLote">
                Home
              </Link>
            </div>
          ...
          : <div>Este Lote No existe</div>
      }
    </div>
  )
}

export default DetailsLoteConfeccionista