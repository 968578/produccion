                            ...
                            <div className="inputIzquierdo">
                              <label className="titlesFormAuditoria" >Defecto en: <span className='asterisco'>*</span><br />
                                <select className="selectNoConformidades" onChange={changeInputNoconformidades} name={`defecto${i}`} >
                                  ...
                                  <option value="T001 Tela con despistes, picas, rotos">T001 Tela con despistes, picas, rotos</option>
                                  <option value="T002 Tela barrada">T002 Tela barrada</option>
                                  <option value="T003 Tela mareada">T003 Tela mareada</option>
                                  <option value="T004 Falla de aguja">T004 Falla de aguja</option>
                                  <option value="T005 Motas tejidas/marras">T005 Motas tejidas/marras</option>
                                  <option value="T006 Pilling/neps">T006 Pilling/neps</option>
                                  <option value="T007 Reviente de lycra">T007 Reviente de lycra</option>
                                  <option value="T008 Tejido contaminado">T008 Tejido contaminado</option>
                                  <option value="T009 Manchas">T009 Manchas</option>
                                  <option value="T010 Tela con mala solidez de color (migración, trasferencia de color, solidez frote)">T010 Tela con mala solidez de color (migración, trasferencia de color, solidez frote)</option>
                                  <option value="T011 Tonos desviados/mezclas de tonos">T011 Tonos desviados/mezclas de tonos</option>
                                  <option value="T012 Problemas de resistencia al desgarre o la tension en la tela">T012 Problemas de resistencia al desgarre o la tension en la tela</option>
                                  <option value="T013 Efecto fantasma en la sublimación">T013 Efecto fantasma en la sublimación</option>
                                  <option value="T014 Irregularidad en tonos sublimados">T014 Irregularidad en tonos sublimados</option>
                                  <option value="T015 Tela con viro">T015 Tela con viro</option>
                                  <option value="T016 Tela con problemas de encogimiento">T016 Tela con problemas de encogimiento</option>
                                  <option value="T017 Tela con mal olor">T017 Tela con mal olor</option>
                                  <option value="T018 Tela engolada">T018 Tela engolada</option>
                                  <option value="T019 Trama desviada o con arco">T019 Trama desviada o con arco</option>
                                  <option value="CT001 Piezas asimétricas desde corte">CT001 Piezas asimétricas desde corte</option>
                                  <option value="CT002 Anchos diferentes de rollo a rollo">CT002 Anchos diferentes de rollo a rollo</option>
                                  <option value="CT003 Rollos con faltante de tela (extendido)">CT003 Rollos con faltante de tela (extendido)</option>
                                  <option value="CT004 Desperdicio fuera del promedio (consumo trazo vs consumo tela cortada)">CT004 Desperdicio fuera del promedio (consumo trazo vs consumo tela cortada)</option>
                                  <option value="CT005 Faltante de piezas en el trazo">CT005 Faltante de piezas en el trazo</option>
                                  <option value="CT006 Mezcla de tonos en el mismo lote">CT006 Mezcla de tonos en el mismo lote</option>
                                  <option value="CT007 Piquetes profundos">CT007 Piquetes profundos</option>
                                  <option value="CT008 Piquetes no realizados">CT008 Piquetes no realizados</option>
                                  <option value="CT009 Manchas por tinta de ticketiado">CT009 Manchas por tinta de ticketiado</option>
                                  <option value="CT010 Piezas sucias o con manchas">CT010 Piezas sucias o con manchas</option>
                                  <option value="CT011 Piezas mal ticketiadas">CT011 Piezas mal ticketiadas</option>
                                  <option value="CT012 Validacion de encogimieto en el extendido">CT012 Validacion de encogimieto en el extendido</option>
                                  <option value="CT013 Formato de informe de corte de produccion, minitrazo y la OP  con informacion incorrecta">CT013 Formato de informe de corte de produccion, minitrazo y la OP  con informacion incorrecta</option>
                                  <option value="CT014 Perforación del tejido por grapa">CT014 Perforación del tejido por grapa</option>
                                  <option value="B001 Hilo de color diferente">B001 Hilo de color diferente</option>
                                  <option value="B002 Tension de puntada inadecuado">B002 Tension de puntada inadecuado</option>
                                  <option value="B003 Agujero por daño de aguja">B003 Agujero por daño de aguja</option>
                                  <option value="B004 Piezas deformadas o desalineadas">B004 Piezas deformadas o desalineadas</option>
                                  <option value="B005 Ubicación incorrecta de plantilla">B005 Ubicación incorrecta de plantilla</option>
                                  <option value="B006 Medidas incorrectas (Dimensiones del bordado)">B006 Medidas incorrectas (Dimensiones del bordado)</option>
                                  <option value="B007 Desuniformidad del bordado">B007 Desuniformidad del bordado</option>
                                  <option value="B008 Manchas">B008 Manchas</option>
                                  <option value="B009 Contaminacion de hilo">B009 Contaminacion de hilo</option>
                                  <option value="B010 Reviente de hilo">B010 Reviente de hilo</option>
                                  <option value="B011 Diseño diferente">B011 Diseño diferente</option>
                                  <option value="E001 Estampado mal ubicado/torcido/inclinado">E001 Estampado mal ubicado/torcido/inclinado</option>
                                  <option value="E002 Diseño de estampado diferente">E002 Diseño de estampado diferente</option>
                                  <option value="E003 Estampado con tono incorrecto">E003 Estampado con tono incorrecto</option>
                                  <option value="E004 Estampado con medidas incorrectas">E004 Estampado con medidas incorrectas</option>
                                  <option value="E005 Termofijado craquelado y/o quemado">E005 Termofijado craquelado y/o quemado</option>
                                  <option value="E006 Estampado con faltante de color">E006 Estampado con faltante de color</option>
                                  <option value="E007 Estampado amarillento por la termofijación">E007 Estampado amarillento por la termofijación</option>
                                  <option value="E008 Repíz">E008 Repíz</option>
                                  <option value="E009 Paros de maquina">E009 Paros de maquina</option>
                                  <option value="E010 Tallones">E010 Tallones</option>
                                  <option value="E011 Dibujo tapado">E011 Dibujo tapado</option>
                                  <option value="E012 Contaminación /manchas">E012 Contaminación /manchas</option>
                                  <option value="E013 Encharques">E013 Encharques</option>
                                  <option value="E014 Estampado con mala solidez (frote, migracion de color, cambio de color)">E014 Estampado con mala solidez (frote, migracion de color, cambio de color)</option>
                                  <option value="E015 Estampado con estrías">E015 Estampado con estrías</option>
                                  <option value="E016 Gofrado torcido / mal ubicado">E016 Gofrado torcido / mal ubicado</option>
                                  <option value="E017 Estampado descasado">E017 Estampado descasado</option>
                                  <option value="E018 Tela quemada por proceso de estampado">E018 Tela quemada por proceso de estampado</option>
                                  <option value="E019 Pega en la tela">E019 Pega en la tela</option>
                                  <option value="C001 Apariencia de la prenda no conforme (sucia, con manchas, stikers)">C001 Apariencia de la prenda no conforme (sucia, con manchas, stikers)</option>
                                  <option value="C002 Filete no esta parejo, abierto, safado o templado, desigual">C002 Filete no esta parejo, abierto, safado o templado, desigual</option>
                                  <option value="C003 Insumos incompletos">C003 Insumos incompletos</option>
                                  <option value="C004 Costuras abiertas">C004 Costuras abiertas</option>
                                  <option value="C005 Hilos sobrantes">C005 Hilos sobrantes</option>
                                  <option value="C006 Marquillas mal ubicadas">C006 Marquillas mal ubicadas</option>
                                  <option value="C007 Hiladilla con problemas de solidez">C007 Hiladilla con problemas de solidez</option>
                                  <option value="C008 Prenda sin hiladilla/suelta">C008 Prenda sin hiladilla/suelta</option>
                                  <option value="C009 Deslizamiento de costura">C009 Deslizamiento de costura</option>
                                  <option value="C010 Cuello encintado o recogido, disparejo, sin asentar, validar si debe ir fusionado">C010 Cuello encintado o recogido, disparejo, sin asentar, validar si debe ir fusionado</option>
                                  <option value="C011 Mangas dispareja o con costuras abiertas">C011 Mangas dispareja o con costuras abiertas</option>
                                  <option value="C012 Botones desalineados">C012 Botones desalineados</option>
                                  <option value="C013 Problemas con la horma/ silueta">C013 Problemas con la horma/ silueta</option>
                                  <option value="C014 Mal olor en la prenda">C014 Mal olor en la prenda</option>
                                  <option value="C015 Costura safada">C015 Costura safada</option>
                                  <option value="C016 Defectos de puntada">C016 Defectos de puntada</option>
                                  <option value="C017 Mal alineamiento">C017 Mal alineamiento</option>
                                  <option value="C018 Prendas asimétricas">C018 Prendas asimétricas</option>
                                  <option value="C019 Costura descasada">C019 Costura descasada</option>
                                  <option value="C020 Costuras onduladas">C020 Costuras onduladas</option>
                                  <option value="C021 Costura retenida">C021 Costura retenida</option>
                                  <option value="C022 Ubicación costuras de remate incorrectos">C022 Ubicación costuras de remate incorrectos</option>
                                  <option value="C023 Costuras torcidas">C023 Costuras torcidas</option>
                                  <option value="C024 Color del hilo diferente a lo establecifo en la ficha">C024 Color del hilo diferente a lo establecifo en la ficha</option>
                                  <option value="C025 Picado por aguja">C025 Picado por aguja</option>
                                  <option value="C026 Costuras sin rematar">C026 Costuras sin rematar</option>
                                  <option value="C027 Pespunte irregular">C027 Pespunte irregular</option>
                                  <option value="C028 Perdida de tensión en la costura">C028 Perdida de tensión en la costura</option>
                                  <option value="C029 Tonalidad diferente en cuellos y puños">C029 Tonalidad diferente en cuellos y puños</option>
                                  <option value="C030 Medidas de la prenda incorrectas">C030 Medidas de la prenda incorrectas</option>
                                  <option value="C031 Mancha de grasa de maquina">C031 Mancha de grasa de maquina</option>
                                  <option value="L001 Tono parejo de rollos a rollo o dentro del mismo rollos">L001 Tono parejo de rollos a rollo o dentro del mismo rollos</option>
                                  <option value="L002 Mal olor en la prenda">L002 Mal olor en la prenda</option>
                                  <option value="L003 Prendas afectadas por excesos de temeratura en proceso">L003 Prendas afectadas por excesos de temeratura en proceso</option>
                                  <option value="L004 Reviente de hilo">L004 Reviente de hilo</option>
                                  <option value="L005 Manualidad diferente a la muestra fisica">L005 Manualidad diferente a la muestra fisica</option>
                                  <option value="L006 Desgaste con ubicación equivocada">L006 Desgaste con ubicación equivocada</option>
                                  <option value="L007 Ausencia de proceso (Definido en en la muestra)">L007 Ausencia de proceso (Definido en en la muestra)</option>
                                  <option value="L008 raya de lavado">L008 raya de lavado</option>
                                  <option value="L009 Manchas de grasa">L009 Manchas de grasa</option>
                                  <option value="L010 Manchas de colorante">L010 Manchas de colorante</option>
                                  <option value="L011 Manchas de hiploclorito">L011 Manchas de hiploclorito</option>
                                  <option value="L012 Rotos/picas ( no se detectan en confeccion pero se rompen en el lavado)">L012 Rotos/picas ( no se detectan en confeccion pero se rompen en el lavado)</option>
                                  <option value="L013 Rotos por rebabas en maquina">L013 Rotos por rebabas en maquina</option>
                                  <option value="L014 Rotos por saturacion de quimico">L014 Rotos por saturacion de quimico</option>
                                  <option value="L015 Lavado disparejo">L015 Lavado disparejo</option>
                                  <option value="L016 Estrias ( tela mal almacenada, maquinas co sobrecargas)">L016 Estrias ( tela mal almacenada, maquinas co sobrecargas)</option>
                                  <option value="L017 Quemon por secadora">L017 Quemon por secadora</option>
                                  <option value="L018 Insumos afectados por concentracion de quimicos">L018 Insumos afectados por concentracion de quimicos</option>
                                  <option value="L019 Medidas de la prenda incorrectas (tamaño de prenda conforme a la ficha tecnica)">L019 Medidas de la prenda incorrectas (tamaño de prenda conforme a la ficha tecnica)</option>
                                  <option value="L020 Rotos inadecuados por motor tool fuerte o lija fuerte">L020 Rotos inadecuados por motor tool fuerte o lija fuerte</option>
                                  <option value="L021 Problemas de resistencia al desgarre en la tela">L021 Problemas de resistencia al desgarre en la tela</option>
                                  <option value="CL001 Exceso de Pegante">CL001 Exceso de Pegante</option>
                                  <option value="CL002 Medidas incorrectas según tabla">CL002 Medidas incorrectas según tabla</option>
                                  <option value="CL003 Asimetría de un zapato a otro">CL003 Asimetría de un zapato a otro</option>
                                  <option value="CL004 Hilos sueltos">CL004 Hilos sueltos</option>
                                  <option value="CL005 Costuras abiertas/sueltas">CL005 Costuras abiertas/sueltas</option>
                                  <option value="CL006 Suela despegada">CL006 Suela despegada</option>
                                  <option value="CL007 Suela deformada">CL007 Suela deformada</option>
                                  <option value="CL008 Calzado no coincide con la muestra física">CL008 Calzado no coincide con la muestra física</option>
                                  <option value="CL009 Marcado y etiquetado incorrecto">CL009 Marcado y etiquetado incorrecto</option>
                                  <option value="CL010 Despegados y/o Falta de pegante">CL010 Despegados y/o Falta de pegante</option>
                                  <option value="CL011 Superficie con Manchas">CL011 Superficie con Manchas</option>
                                  <option value="CL012 Piezas partidas">CL012 Piezas partidas</option>
                                  <option value="CL013 Perforaciones">CL013 Perforaciones</option>
                                  <option value="CL014 Suela pelada">CL014 Suela pelada</option>
                                  <option value="CL015 Insumos y/o accesorios sueltos/despegados">CL015 Insumos y/o accesorios sueltos/despegados</option>
                                  <option value="CL016 Insumos y/o accesorios con óxido">CL016 Insumos y/o accesorios con óxido</option>
                                  <option value="CL017 Falta de Costura o descosido">CL017 Falta de Costura o descosido</option>
                                  <option value="CL018 Superficie pelada">CL018 Superficie pelada</option>
                                  <option value="CL019 Insumos y/o accesorios dañados">CL019 Insumos y/o accesorios dañados</option>
                                  <option value="CL020 Terminación irregular">CL020 Terminación irregular</option>
                                  <option value="CL021 Mala solidez y/o Migra color en el textil">CL021 Mala solidez y/o Migra color en el textil</option>
                                  <option value="CL022 Cuero PU vencido">CL022 Cuero PU vencido</option>
                                  <option value="CL023 Superficie surcada (Rayada)">CL023 Superficie surcada (Rayada)</option>
                                  <option value="CL024 Capellada mal armada">CL024 Capellada mal armada</option>
                                  <option value="CL025 Material con distinto color y textura">CL025 Material con distinto color y textura</option>
                                  <option value="CL026 Etiqueta incorrecta/ despegada">CL026 Etiqueta incorrecta/ despegada</option>
                                  <option value="CL027 Talla no corresponde entre el par">CL027 Talla no corresponde entre el par</option>
                                  <option value="CL028 Talla no corresponde entre la medida">CL028 Talla no corresponde entre la medida</option>
                                  <option value="CL029 Presenta manchas y lama de humedad">CL029 Presenta manchas y lama de humedad</option>
                                  <option value="CL030 Presenta rotos">CL030 Presenta rotos</option>
                                  <option value="CL031 Diferencia de tonalidad">CL031 Diferencia de tonalidad</option>
                                  <option value="CL032 Logos incorrectos (Tamaño, color, ubicación)">CL032 Logos incorrectos (Tamaño, color, ubicación)</option>
                                  <option value="CL033 Puntillas internas">CL033 Puntillas internas</option>
                                  <option value="ACC001 Medidas incorrectas">ACC001 Medidas incorrectas</option>
                                  <option value="ACC002 Material en mal estado">ACC002 Material en mal estado</option>
                                  <option value="ACC003 Cosidos o uniones mal pegadas">ACC003 Cosidos o uniones mal pegadas</option>
                                  <option value="ACC004 Hebillas, herrajes, taches en mal estado">ACC004 Hebillas, herrajes, taches en mal estado</option>
                                  <option value="ACC005 Diseño diferente a la muestra fisica">ACC005 Diseño diferente a la muestra fisica</option>
                                  <option value="ACC006 Color diferente a la muestra fisica">ACC006 Color diferente a la muestra fisica</option>
                                  <option value="ACC007 Horma diferente a la muestra fisica">ACC007 Horma diferente a la muestra fisica</option>
