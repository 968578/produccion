    ...
    <div>
      {
        ...
        <motion.div custom={props.index} initial='hidden' animate='show' variants={variantsLote} className="containerLoteDestacado">
          ...
          <div className="containerDuo">
            <div className='loteTitle'>Fecha Probable de Entrega:</div>
          ...
          <div className="containerDuo">
            {
              props.showLote.estado === 'Confeccion' &&
              <div  >

                <motion.svg custom={props.index} className='svgMaquina' initial='hidden' animate='show' variants={variantsInconMaquina} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1920">
            ...
            {
              props.showLote.estado === 'Lavanderia' &&
              <div >
                <motion.svg custom={props.index} className='svgLavanderia' initial='hidden' animate='show' variants={variantsInconMaquina} viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg">
